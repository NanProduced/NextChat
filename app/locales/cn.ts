...
const cn = {
  ...
  Chat: {
    ...
    Arena: {
      ...
      ModelCount: (count: number) => `已选 ${count}`,
      Stop: "停止",
      Streaming: "生成中…",
      Error: "出错了",
      NoModels: "暂无可用模型",
      ...
      PresetDomestic: "国产对决",
      PresetOpenSource: "开源之战",
      Selected: "已选模型",
      DefaultBadge: "默认",
      ShowMore: (count: number) => `显示更多 (${count} 个)`,
      ShowLess: "收起列表",
      MinModelsHint: "⚠️ 对决需要至少 2 位选手，请继续选择",
      MaxModelsHint: (max: number) => `✅ 战场已满员（${max} 位）`,
      SelectionHint: (current: number, max: number) =>
        `还可选择 ${max - current} 位选手`,
      LastUsed: "上次使用",
      BlindMode: "盲测模式",
      BlindToggle: "盲测",
      VoteUp: "👍 这个更好",
    ...
    Access: {
      ...
      OpenAI: {
        ...
        Endpoint: {
          ...
          TestSuccess: "成功",
          TestFailed: "失败",
          ConnectionSuccess: "连接成功！发现 {0} 个可用模型",
