...
const en: LocaleType = {
  ...
  Chat: {
    ...
    Arena: {
      ...
      ModelCount: (count: number) => `${count} selected`,
      Stop: "Stop",
      ...
      ShowLess: "Show less",
      MinModelsHint: "⚠️ Arena needs at least 2 contestants, keep selecting",
      MaxModelsHint: (max: number) => `✅ Arena full (${max} contestants)`,
      SelectionHint: (current: number, max: number) =>
        `${max - current} more can be selected`,
      LastUsed: "Last Used",
    ...
    Access: {
      ...
      OpenAI: {
        ...
        Endpoint: {
          ...
          TestSuccess: "Success",
          TestFailed: "Failed",
          ConnectionSuccess: "Connected! Found {0} available models",
